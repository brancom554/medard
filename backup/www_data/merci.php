               ...
               <div class="event_details">
                    ...
                    <div class="event_location_info">                  
                        <ul class="list-unstyled">
                            ...
                            <li><p>Email</p><span>MYGENO-GROUP-banque-services.com</span></li>                        
                            <li><p>Phone</p><span>+336-4467-6274</span><br><span>+77 0251 215 1235</span></li>
                        </ul>
            ...
            <div class="row">                  
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 ml-auto p-0">
                     <div class="leave_comment">
                        <h3 class="title">Nous avons bien reçu votre message et nous vous recontacterons dans un délai de 24h ouvrables.</h3>
                        <div id="message"></div>
