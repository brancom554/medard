...
<head>
    ...
    <title>MYGENO-GROUP - Crédit fournisseur</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Service affacturage</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="courses_info_content">
                            ...
                            <div class="courses_tab_wrapper">  
								...
								<b>UNE PANOPLIE D'AVANTAGES</b><br>

Le crédit fournisseur est un prêt bancaire accordé directement au fournisseur lui permettant d'octroyer des
 différés de paiement aux acheteurs. Le crédit fournisseur permet au fournisseur d'escompter sa créance et 
 d'encaisser, au moment de la livraison partielle ou totale de l'exportation, le montant des sommes qui lui
 sont dues par l'acheteur étranger.
<br>
<b>VOS BESOINS</b><br>

Vous avez importé de la marchandise et vous souhaitez bénéficier de crédit moyen ou long terme accordé par
 votre fournisseur moyennant le règlement par des effets avalisés. La relation entre l'acheteur et le vendeur
 est régie par un seul contrat qui est le contrat commercial stipulant aussi bien les conditions commerciales 
 que financières.
