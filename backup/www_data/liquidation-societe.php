...
<head>
    ...
    <title>MYGENO-GROUP - Liquidation de societe</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Liquidation de sociétés</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="courses_info_content">
                            ...
                            <div class="courses_tab_wrapper">  
								...
								<b>Liquidation entreprise par MYGENO-GROUP</b><br>
La liquidation d’une entreprise est une procédure réglementée qui nécessite le respect de plusieurs formalités.
 Nous vous proposons de gérer pour vous l'ensemble des formalités de liquidation d’entreprise afin de vous faire
 gagner un temps précieux.
<br>
<br>- Suivi par téléphone & chat ;
<br>- Service 100% dématérialisé ;
<br>- Rédaction des actes juridiques ;
<br>- Obtention de votre kbis de liquidation en 48h
<br>

<b>Effets de la liquidation</b><br>

Conséquence automatique d’une dissolution-liquidation d’entreprise (sauf cas particuliers comme 
celui de sociétés unipersonnelles détenues par une société mère), la liquidation d'une société 
marque la fin de vie définitive de celle-ci. Elle peut être le fait d'une décision des associés,
... on parle alors de liquidation volontaire (également appelée liquidation amiable), par opposition
 à la liquidation judiciaire demandée par les créanciers de celle-ci.
<br>
...
<br>- Copie du RCS de la société liquidée
<br>- Copie certifiée conforme du procès verbal mentionnant le vote de la liquidation
<br>- Formulaire M2 disponible sur le site gouvernemental dédié à la simplification des procédures administratives) rempli pour les cases relatives à la liquidation de la société, et signé par la ou les personnes habilitées
<br>- L'attestation de parution et la copie de l'avis publié dans un journal d'annonces légales
