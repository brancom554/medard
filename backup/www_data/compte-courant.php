...
<head>
    ...
    <title>MYGENO-GROUP - Compte courant</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Compte courant</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="courses_tab_wrapper">  
                                ...
                                <div class="tab_contents tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active show" id="information">
                                        <p>
								On sait que vous aimez gérer votre compte courant librement et simplement. Ici, on vous propose 2 offres 
								de Compte Courant adaptées à vos besoins. Chaque offre comprend :
								<ul>
<li>Une carte Mastercard® gratuite</li>
<li>Des Opérations courantes à 0€</li>
<li>Des fonctionnalités et services en ligne qui vous facilitent vraiment le quotidien et bien sûr,</li>
<li>la disponibilité de nos conseillers quand vous en avez besoin (et même le samedi toute la journée !)</li>
                                 </ul>
										</p>
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title click">
                                                                ...
                                                                Vous maîtrisez vos dépenses quotidiennes sans stress d’être à découvert</a>
                                                            </h4>
                                                        ...
                                                        <div id="collapse1" class="panel-collapse collapse in show">
                                                            <div class="panel-body">
                                                                <div class="curriculum-single">
                                                                    Une carte Standard Mastercard®
Le débit immédiat
Un plafond d’achat de 2000€ (sur 30 jours glissants)
