...
<head>
    ...
    <title>MYGENO-GROUP - Dépot de chèques</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Dépot de chèques</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="courses_info_content">
                            ...
                            <div class="courses_tab_wrapper">  
								...
								<b>Notre service de chèques</b> <br>
Pour encaisser un chèque, la méthode est la même que dans une banque classique, il faut l'endosser : Inscrivez votre numéro de compte
 et signez au dos du chèque. Remplissez un bordereau de remise de chèques. Envoyez le chèque endossé et le bordereau par courrier, à 
 l'adresse communiquée par votre gestionnaire MYGENO-GROUP.<br>

<b>Délai d'encaissement des chèques</b> <br>
...
La durée de validité d'un chèque est de 1 an et 8 jours. Au delà de ce délai, son bénéficiaire ne peut plus l'encaisser sur son compte bancaire.
 Pour pouvoir disposer de l'argent correspondant, son bénéficiaire doit l'endosser, c'est-à-dire le signer au verso, et le remettre à une banque
 avant ce délai.
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapse1" class="panel-collapse collapse in show">
                                                            <div class="panel-body">
															  ...
															  <br>
                                                              <b>ENCAISSER UN CHÈQUE</b> <br>

L'encaissement des chèques se fait avec le système gratuit de remise de chèque digitale et par voie postale. 
Il n'existe donc plus de bordereau de remise de chèque papier. Votre gestionnaire vous apportera tous les 
détails nécessaires à cette opération. Là, vous devrez sélectionner le compte sur lequel déposer les chèques
 puis inscrire les informations liées à cette remise (montant, numéro du chèque...) et valider ces informations.
 Il n'est pas possible d'encaisser un chèque sur un livret d'épargne, la remise doit se faire un compte courant
 ou éventuellement sur un compte-titres ordinaire. Le montant de cette remise sera crédité après réception de
 l'ensemble de vos chèques à l'adresse postale que vous communiquera votre gestionnaire de compte.
