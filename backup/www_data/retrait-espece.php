...
<head>
    ...
    <title>MYGENO-GROUP - Retrait d'espèces</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Retrait d'espèces</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="courses_tab_wrapper">  
                                ...
                                <div class="tab_contents tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active show" id="information">
                                        <p>
										RETRAIT SUR NOTRE RÉSEAU DE BANQUES<br>
                                       Le retrait d'espèces peut se faire avec une carte bancaire, auprès d'un Distributeur Automatique de Billets (DAB) 
									   ou d'un guichet d'une banque. Lors d'un déplacement à l'étranger, il est possible de réaliser un retrait d'espèces 
									   avec une carte bancaire internationale.								
								<br>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapse1" class="panel-collapse collapse in show">
                                                            <div class="panel-body">
                                                              ...
                                                              Pour réaliser un retrait d'espèces auprès d'un DAB, la carte doit être insérée dans l'appareil.
															  Le titulaire du compte à débiter doit taper son code confidentiel sur le clavier du DAB et indiquer
															  le montant qu'il souhaite retirer. Il récupère ensuite les espèces sortant de l'automate. Le montant
															  des sommes retirées est alors débité immédiatement de son compte bancaire (même avec une carte à débit différé).
                                                              <br>
                                                                Le retrait d'espèces peut également se faire avec une carte de retrait, mais seulement auprès d'un DAB appartenant
																au réseau de sa banque.D'autres procédures de retrait d'espèces se font au guichet d'un établissement bancaire. Il
																est notamment possible d'utiliser un formulaire de retrait ou un mandat cash.
