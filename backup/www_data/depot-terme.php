...
<head>
    ...
    <title>MYGENO-GROUP - Dépôt à terme</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Dépot à terme</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="courses_tab_wrapper">  
                                ...
                                <div class="tab_contents tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active show" id="information">
                                        <p>
								Avec les dépôts à terme ou « DAT », vous placez votre argent pendant quelques mois ou plusieurs années. 
								Pas de surprise ! Vous bénéficiez d’une rémunération dont les conditions sont définies dès la souscription.
								Notre gamme de dépôts à terme vous permet de choisir entre plusieurs formules. Pour placer vos excédents de
								trésorerie sur une durée et à un taux connus à l’avance. <br>
- Le choix de la durée<br>
- Des conditions de rémunération connues dès la souscription<br>
- Un capital garanti<br>
- La possibilité de détenir plusieurs DAT
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title click">
                                                                ...
                                                                DES FONCTIONNALISÉS À VOTRE MAIN</a>
                                                            </h4>
                                                        ...
                                                        <div id="collapse1" class="panel-collapse collapse in show">
                                                            <div class="panel-body">
                                                               ...
                                                               ous concevons toutes nos offres pour vous permettre de les utiliser au plus près de
															   vos besoins. Les dépôts à terme proposés par le Crédit Agricole, c’est donc aussi les
															   services et/ou options suivants, à votre main, qui peuvent faire l'objet d'un contrat
															   et/ou d'une tarification spécifique :
                                                              <br>
                                                                <ul>

                                                                <li>Choisir la durée de son placement</li>
<li>Préférer un taux fixe ou un taux progressif</li>
<li>Opter parmi différentes modalités de versement des intérêts </li>
