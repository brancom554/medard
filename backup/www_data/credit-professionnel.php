...
<head>
    ...
    <title>MYGENO-GROUP - Le crédit professionnel</title>
            ...
            <div class="col-sm-10 col-md-12 col-lg-12">
                <div class="intro_text">
                    ...
                    <div class="pages_linka">
                        ...
                        <a href="#" title="" class="active">Le crédit professionnel</a>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapse1" class="panel-collapse collapse in show">
                                                            <div class="panel-body">
															  ...
															  <br>
                                                              <b>Mettre toutes les chances de son côté !</b>

Ainsi il convient de se préparer à cet entretien afin de démontrer que le banquier va acquérir un nouveau client fiable.
 Pour ce faire, le dossier de financement doit être complet afin d'éviter les demandes ultérieures de documents et les 
 allers-retours. Ceci peut aussi démontrer une certaine rigueur du chef d'entreprise. L'entrepreneur doit connaître son
 dossier sur le bout des doigts et justifier tous les éléments du bilan prévisionnel. Il doit aussi connaître les critères
 de la banque afin de s'assurer de leur respect ou de pouvoir rebondir sur les points faibles du projet.
