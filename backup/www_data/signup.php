        ...
        <div class="row">        
            ...
            <div class="col-sm-10 col-md-8 col-lg-8">
                <div class="apply_instructor">
                    ...
                    <form  method="POST" action="creerClient1.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="snom" class="form-control"  placeholder="">
                                </div>&nbsp;&nbsp;
								<div class="form-group">
                                    <label class="control-label">Pays de residence</label>
                                    <input type="text" name="spays" class="form-control"  placeholder="">
                                </div>
								</div>
                            </div>                            
                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
							  <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="semail" class="form-control"  placeholder="">
                                </div>&nbsp;&nbsp;
								<div class="form-group">
                                    <label class="control-label">Telephone</label>
                                    <input type="text" name="stel" class="form-control"  placeholder="">
                                </div>
								</div>
                            </div> 
                           ...
                           <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
							  <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sville" class="form-control"  placeholder="">
                                </div>&nbsp;&nbsp;
                            ...
                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
							  <div class="row">
                                <div class="form-group">
                                    <label class="control-label">Photo d'identité</label>
                                    <input type="file" name="image" class="form-control" required placeholder="Joignez une pièce d’identité">
                                </div>&nbsp;&nbsp;
                            ...
                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-6">
                                     <button type="submit" class="btn btn-default submit_btn">S'inscrire</button>
                                </div>
