            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
						...
						<form id="register-form" class="form" action="activerClient1.php" method="post">
						...
						<div class="control-group control-inline">
        		        	...
        		        	<div class="control-group control-inline">
        		        		...
        		        		<select name="numeroCompte" class="input-medium" >
...
echo '<option value="'.$ttt2.'">'.$nom.'&nbsp;&nbsp;'.$prenom.'</option>';
   ...
   ?>
        		            ...
        		            <button type="submit" class="btn btn-success">Activer Client</button>
        		        </div>
