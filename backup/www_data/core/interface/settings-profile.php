  ...
  <div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav secondary-nav">
        <li class="nav-item"> <a class="nav-link active" href="settings-profile.php">Mon profil</a></li>
      ...
      <div class="row"> 
        ...
        <div class="col-lg-9"> 
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 d-flex align-items-center mb-4">Details personnels<!--a href="#edit-personal-details" data-toggle="modal" class="ml-auto text-2 text-uppercase btn-link"><span class="mr-1"><i class="fas fa-edit"></i></span>Edit</a--></h3>
            <hr class="mx-n4 mb-4">
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Nom:</p>
              <p class="col-sm-9 text-3"><?php echo $_SESSION["nom"].'&nbsp;&nbsp;'.$_SESSION["prenom"];?></p>
            </div>
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Pays de residence:</p>
              <p class="col-sm-9 text-3"><?php echo $_SESSION["pays"];?></p>
            </div>
            <div class="form-row align-items-baseline">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Adresse:</p>
              <p class="col-sm-9 text-3"><?php echo $_SESSION["adresse"];?>
              
              </p>
            </div>
            <div class="form-row align-items-baseline">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Ville:</p>
              <p class="col-sm-9 text-3"><?php echo $_SESSION["ville"];?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Details personnels</h5>
                ...
                <div class="modal-body p-4">
                  <form id="personaldetails" method="post">
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $_SESSION["prenom"];?>" class="form-control" data-bv-field="firstName" id="firstName" required placeholder="First Name">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="fullName">Nom</label>
                          <input type="text" value="<?php echo $_SESSION["nom"];?>" class="form-control" data-bv-field="fullName" id="fullName" required placeholder="Full Name">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label for="birthDate">Pays</label>
                          <div class="position-relative">
                            <input id="birthDate2" value="<?php echo $_SESSION["pays"];?>" type="text" class="form-control" required placeholder="Pays de residence">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $_SESSION["adresse"];?>" class="form-control" data-bv-field="address" id="address" required placeholder="Address 1">
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label for="city">Ville</label>
                          <input id="city" value="<?php echo @$_SESSION["ville"];?>" type="text" class="form-control" required placeholder="City">
                        </div>
                      </div>
                    ...
                    <button class="btn btn-primary btn-block mt-2" type="submit">Sauvegarder les changements</button>
                  </form>
                </div>
              </div>
            </div>
          ...
          ============================================= -->
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 d-flex align-items-center mb-4">Email</h3>
            <hr class="mx-n4 mb-4">
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email :</p>
              <p class="col-sm-9 text-3"><?php echo $_SESSION["email"];?><span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-2">Primaire</span></p>
            </div>
          ...
          <div id="edit-email" class="modal fade " role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Email </h5>
                  <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
                <div class="modal-body p-4">
                  <form id="emailAddresses" method="post">
                    <div class="form-group">
                      <label for="emailID">Email ID <span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-1">Primaire</span></label>
                      <input type="text" value="<?php echo $_SESSION["email"];?>" class="form-control" data-bv-field="emailid" id="emailID" required placeholder="Email ID">
                    </div>
          ...
          ============================================= -->
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 d-flex align-items-center mb-4">Telephone</h3>
            <hr class="mx-n4 mb-4">
            <div class="form-row align-items-center">
              <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Mobile:</p>
              <p class="col-sm-9 text-3 align-items-center d-flex"><?php echo $_SESSION["telephone"];?><span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-2">Primaire</span></p>
            </div>
          ...
          <div id="edit-phone" class="modal fade " role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Telephone</h5>
                  <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
                <div class="modal-body p-4">
                  <form id="phone" method="post">
                    <div class="form-group">
                      <label for="mobileNumber">Mobile <span class="badge badge-info text-1 font-weight-500 rounded-pill px-2 py-1 ml-1">Primaire</span></label>
                      <div class="input-group">
                        ...
                        <input type="text" value="<?php echo $_SESSION["telephone"];?>" class="form-control" data-bv-field="mobilenumber" id="mobileNumber" required placeholder="Mobile Number">
                      </div>
                    </div>
